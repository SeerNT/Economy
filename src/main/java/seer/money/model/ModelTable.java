...
public class ModelTable extends ModelBase {
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4,float f5) {
		...
		setRotationAngeles(entity, f, f1, f2, f3, f4, f5);
		Shape1.render(f5);
		Shape2.render(f5);
		Shape3.render(f5);
		Shape4.render(f5);
	...
	private void setRotationAngeles(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
