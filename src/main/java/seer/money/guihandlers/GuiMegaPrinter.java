...
public class GuiMegaPrinter extends GuiContainer{
	
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("money", "textures/blocks/PrinterGui.png");
	private MegaTileEntity tileFurnace;

	public GuiMegaPrinter(InventoryPlayer invPlayer, MegaTileEntity tile) {
		super(new ContainerMegaPrinter(invPlayer, tile));
