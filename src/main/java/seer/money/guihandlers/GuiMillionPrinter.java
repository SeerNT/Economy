...
public class GuiMillionPrinter extends GuiContainer{
	
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("money", "textures/blocks/PrinterGui.png");
	private MillionTileEntity tileFurnace;

	public GuiMillionPrinter(InventoryPlayer invPlayer, MillionTileEntity tile) {
		super(new ContainerMillionPrinter(invPlayer, tile));
