...
public class ContainerMillionPrinter extends Container {
	...
	public ContainerMillionPrinter(InventoryPlayer player, MillionTileEntity tileEntityFurnace){
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				}else if(PrinterTileEntity.isItemFuel(itemstack1)){
