...
public class GuiOmegaPrinter extends GuiContainer{
	
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("money", "textures/blocks/PrinterGui.png");
	private OmegaTileEntity tileFurnace;

	public GuiOmegaPrinter(InventoryPlayer invPlayer, OmegaTileEntity tile) {
		super(new ContainerOmehaPrinter(invPlayer, tile));
