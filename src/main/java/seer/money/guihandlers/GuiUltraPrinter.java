...
public class GuiUltraPrinter extends GuiContainer{
	
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("money", "textures/blocks/PrinterGui.png");
	private UltraTileEntity tileFurnace;

	public GuiUltraPrinter(InventoryPlayer invPlayer, UltraTileEntity tile) {
		super(new ContainerUltraPrinter(invPlayer, tile));
