...
public class ContainerItem extends Container
{
	...
	public static SlotItemInv slotWallet;
	...
	public ContainerItem(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, InventoryItem inventoryItem)
	{
		...
		for (i = 0; i < InventoryItem.INV_SIZE; ++i)
		{
			...
			slotWallet = new SlotItemInv(this.inventory, i, 100 + (18 * (int)(i/4)), 8 + (18*(i%4)));
			this.addSlotToContainer(slotWallet);
		}
		...
		for (i = 0; i < 4; ++i)
		{
			...
			this.addSlotToContainer(new SlotArmor(inventoryPlayer, inventoryPlayer.getSizeInventory() - 1 - i, 8, 8 + i * 18));
		}
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int index)
	{
		...
		if (slot != null && slot.getHasStack())
		{
			...
			else
			{
				...
				if (itemstack1.getItem() instanceof Wallet)
				{
