...
public class RubyArmor extends ItemArmor {
	...
	public RubyArmor(int renderIndex, int armorType) {
	  super(Test.rubyMat, renderIndex, armorType);
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type){
		if (this.armorType == 2) {
			return "money:textures/models/armor/ruby_layer_2.png";
		}
		return "money:textures/models/armor/ruby_layer_1.png";
