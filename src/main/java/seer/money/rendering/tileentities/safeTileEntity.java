...
{ 
    ...
    public safeTileEntity()
    {
        ...
        this.item_type_amount = new int[64];
        this.item_type_amount[0] = 0;
    }

    @SideOnly(Side.CLIENT)
    public safeTileEntity(int p_i2350_1_)
    {
    ...
    private void func_145978_a(safeTileEntity safeTileEntity, int p_145978_2_)
    {
        if (safeTileEntity.isInvalid())
        {
            this.adjacentChestChecked = false;
        }
        else if (this.adjacentChestChecked)
        {
            ...
            {
                case 0:
                    if (this.adjacentChestZPos != safeTileEntity)
                    {
                        this.adjacentChestChecked = false;
                    }
                    ...
                    break;
                case 1:
                    if (this.adjacentChestXNeg != safeTileEntity)
                    {
                        this.adjacentChestChecked = false;
                    }
                    ...
                    break;
                case 2:
                    if (this.adjacentChestZNeg != safeTileEntity)
                    {
                        this.adjacentChestChecked = false;
                    }
                    ...
                    break;
                case 3:
                    if (this.adjacentChestXPos != safeTileEntity)
                    {
                        this.adjacentChestChecked = false;
                    }
            }
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (safeTileEntity)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (safeTileEntity)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (safeTileEntity)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (safeTileEntity)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        else
        {
            ...
            return block instanceof safe && ((safe)block).field_149956_a == this.func_145980_j();
        }
    }
    ...
    public void updateEntity()
    {
        ...
        item_type_amount[0] = GuiShop.item1_type_amount;
        isBought = GuiShop.isBought;
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof safe))
            {
                return 0;
            }

            this.cachedChestType = ((safe)this.getBlockType()).field_149956_a;
        }
