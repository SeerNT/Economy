...
public class PrinterTileEntity extends TileEntity implements ISidedInventory {
	...
	public void onCreated(Block item, World world, EntityPlayer player) {
		if(!player.worldObj.isRemote) {
			if(item.isEqualTo(Test.Printer, item)) {
				player.addStat(CommonProxy.achievementPrinter, 1);
			}
		}
	}
