...
public class OmegaPrinter extends BlockContainer {
	...
	protected OmegaPrinter(boolean isActive,Block p_i45428_1_, int p_i45428_2_) {
		
		super(Material.rock);
		this.field_150149_b = p_i45428_1_;
		this.isBurning2 = isActive;
		this.setBlockName("Omega Printer");
		this.setCreativeTab(Test.tools);
		this.setHardness(40F);
		this.setResistance(6F);
		this.setHarvestLevel("pickaxe",3);
		this.setBlockTextureName("money:OmegaPrinter");
	}
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
            OmegaTileEntity tileentityfurnace = (OmegaTileEntity)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
		player.openGui(Test.instance, 5, world, x, y, z);
		return true;
	}
	...
	public static void updateBlockState(boolean burning, World world, int x, int y, int z) {
		...
		if (burning) {
			world.setBlock(x, y, z, Test.OmegaPrinter);
		} else {
			world.setBlock(x, y, z, Test.OmegaPrinter);
		}
