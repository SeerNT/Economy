...
public class OmegaTileEntity extends TileEntity implements ISidedInventory {
	public OmegaTileEntity() {
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			OmegaPrinter.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
