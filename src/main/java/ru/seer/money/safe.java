...
import seer.money.guihandlers.GuiSafe;
...
public class safe extends BlockContainer {
	...
	protected safe(int p_i45397_1_) {
		super(Material.wood);
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((safeTileEntity)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    {
    	EntityPlayer player = p_149742_1_.getClosestPlayer(p_149742_2_, p_149742_3_, p_149742_4_, 15);
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        safeTileEntity tileentitychest = (safeTileEntity)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);
    ...
    {
        Object object = (safeTileEntity)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
    ...
    {
    	safeTileEntity tileentitychest = new safeTileEntity();
    ...
    public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_, int p_149709_5_)
    {
        ...
        {
            int i1 = ((safeTileEntity)p_149709_1_.getTileEntity(p_149709_2_, p_149709_3_, p_149709_4_)).numPlayersUsing;
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("money:safeIcon");
    }
