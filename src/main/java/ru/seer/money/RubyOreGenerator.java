...
public class RubyOreGenerator implements IWorldGenerator {
	...
	public void generateOverworld(World world, Random rand, int blockXPos, int blockZPos) {
	  ...
	  addOreSpawn(Test.RubyOre, Blocks.stone, world, rand, blockXPos, blockZPos, 16, 16, 1, 4, 4, 12, 30, 5, 18);

	}

	public void generateNether(World world, Random rand, int blockXPos, int blockZPos) {

	  addOreSpawn(Test.RubyOre, Blocks.netherrack, world, rand, blockXPos, blockZPos, 16, 16, 1, 2, 1, 1, 10, 5, 6);

	}

	public void generateEnd(World world, Random rand, int blockXPos, int blockZPos) {

	   addOreSpawn(Test.RubyOre, Blocks.end_stone, world, rand, blockXPos, blockZPos, 16, 16, 1, 4, 1, 8, 7, 5, 18);
