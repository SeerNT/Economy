...
public class Printer extends BlockContainer {
	...
	protected Printer(boolean isActive,Block p_i45428_1_, int p_i45428_2_) {
		...
		this.setBlockTextureName("money:Printer");
	}
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if (!field_149934_M)
        {
            PrinterTileEntity tileentityfurnace = (PrinterTileEntity)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
     ...
     */
    public int onBlockPlaced(EntityPlayer p,World p_149660_1_, int p_149660_2_, int p_149660_3_, int p_149660_4_, int p_149660_5_, float p_149660_6_, float p_149660_7_, float p_149660_8_, int p_149660_9_)
    {
	...
	public static void updateBlockState(boolean burning, World world, int x, int y, int z) {
		...
		if (burning) {
			world.setBlock(x, y, z, Test.Printer);
		} else {
			world.setBlock(x, y, z, Test.Printer);
		}
