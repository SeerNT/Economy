...
public class UltraTileEntity extends TileEntity implements ISidedInventory {
	public UltraTileEntity() {
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			UltraPrinter.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
