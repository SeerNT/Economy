...
public class SapphireOreGenerator implements IWorldGenerator {
	...
	public void generateOverworld(World world, Random rand, int blockXPos, int blockZPos) {
	  ...
	  addOreSpawn(Test.SapphireOre, Blocks.stone, world, rand, blockXPos, blockZPos, 16, 16, 1, 4, 4, 12, 35, 5, 25);

	}

	public void generateNether(World world, Random rand, int blockXPos, int blockZPos) {

	  addOreSpawn(Test.SapphireOre, Blocks.netherrack, world, rand, blockXPos, blockZPos, 16, 16, 1, 2, 1, 1, 14, 5, 40);

	}

	public void generateEnd(World world, Random rand, int blockXPos, int blockZPos) {

	   addOreSpawn(Test.SapphireOre, Blocks.end_stone, world, rand, blockXPos, blockZPos, 16, 16, 1, 4, 1, 8, 10, 5, 25);
