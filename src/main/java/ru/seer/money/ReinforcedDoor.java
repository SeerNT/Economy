...
public class ReinforcedDoor extends Block {
    ...
    protected ReinforcedDoor(Material p_i45402_1_)
    {
        super(p_i45402_1_);
        float f = 0.5F;
        float f1 = 1.0F;
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        this.field_150017_a[0] = p_149651_1_.registerIcon("money:door_iron_upper");
        this.field_150016_b[0] = p_149651_1_.registerIcon("money:door_iron_lower");
    ...
    {
        return (p_149650_1_ & 8) != 0 ? null : (this.blockMaterial == Material.iron ? Test.ReinforcedDoorItem : Test.ReinforcedDoorItem);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? Test.ReinforcedDoorItem : Test.ReinforcedDoorItem;
    }
