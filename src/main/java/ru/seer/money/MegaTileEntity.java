...
import seer.money.rendering.tiles.MegaPrinterRecipes;

public class MegaTileEntity extends TileEntity implements ISidedInventory {
	public MegaTileEntity() {

	}
	private String printerName;
	private static final int[] slotsTop = new int[] { 0 };
	private static final int[] slotsBottom = new int[] { 3, 2, 1 };
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.printerName : "Printer";
	}
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			MegaPrinter.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
	...
	private boolean canSmelt() {
		if (this.furnaceItemStacks[0] == null) {
			...
			ItemStack itemstack = MegaPrinterRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
