...
public class ShopRecipes {
	private static final ShopRecipes SMELTING_BASE = new ShopRecipes();

	private Map smeltingList = new HashMap();
	private Map experienceList = new HashMap();

	public static ShopRecipes smelting() {
		return SMELTING_BASE;
	}
	
	private ShopRecipes(){
		//this.addRecipie(Items.paper, new ItemStack(Test.Dollars), 0.8F);
		//2€this.addRecipie(Items.gold_nugget, new ItemStack(Test.Cents), 0.8F);
	}
